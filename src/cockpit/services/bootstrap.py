...
DEFAULT_APPS: list[dict] = [
    ...
    # NUC — bisher unüberwacht (Konsistenz-Audit F10): ergänzt
    {"host": "nuc", "name": "krypto", "container_filter": "name=krypto-",
     "compose_path": "/home/janpow/Projekte/krypto/docker-compose.yml",
     "tags": ["krypto", "analyse"]},
    {"host": "nuc", "name": "love-ai", "container_filter": "name=love-ai-",
     "compose_path": "/home/janpow/Projekte/x_chat/love-ai/docker-compose.yml",
     "tags": ["chat"]},
    {"host": "nuc", "name": "flowsearch", "container_filter": "name=flowsearch-",
     "compose_path": "/home/janpow/Projekte/flowsearch/docker-compose.yml",
     "tags": ["search"]},
    {"host": "nuc", "name": "riskanalysis", "container_filter": "name=riskanalysis-",
     "compose_path": "/home/janpow/Projekte/riskanalysis/docker-compose.yml",
     "tags": ["audit", "risk"]},
    {"host": "nuc", "name": "flowaudit", "container_filter": "name=flowaudit-",
     "compose_path": "/home/janpow/Projekte/flowaudit/docker-compose.yml",
     "tags": ["audit"]},
    # TODO (M11b): evo-x2 als 3. Host — systemd statt Docker → eigener HTTP/systemctl-Probe-Pfad,
    # nicht über docker_inspect. Eigenes Feature, daher hier (noch) nicht als App.
    # CCX23

  ...
  <div class="min-h-screen grid place-items-center px-4" style="background: var(--app-bg)">
    <div class="w-full max-w-sm">
      <div class="text-center mb-8">
        ...
        <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Cockpit, Anwendungen, Repositories und LLM-Konsole – ein Zugang.</p>
      </div>
      ...
      >
        ...
        <p class="mt-4 text-[11px] text-slate-400 flex items-center gap-1.5"><Radar :size="12" /> Nach der Anmeldung: Cockpit unter /admin/wall, LLM-Konsole unter /admin/chat. Zugriff nur über Tailscale.</p>
      </form>
    </div>
  </div>
</template>

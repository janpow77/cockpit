...
import { Plane, KeyRound } from 'lucide-vue-next'
  ...
  <div class="min-h-screen grid place-items-center px-4" style="background: var(--app-bg)">
    <div class="w-full max-w-sm">
      <div class="text-center mb-8">
        ...
        <h1 class="text-xl font-semibold tracking-tight text-slate-900 dark:text-slate-100">Cockpit Admin</h1>
        <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Multi-App-Multi-Host-Verwaltung.</p>
      </div>
